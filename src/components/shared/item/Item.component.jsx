    ...
    return (
                ...
                <div className="card card-item">
                    ...
                    <div className="card-body card-item-body">
                        ...
                        <p className="card-text"><span className="badge bg-primary">{item.category}</span></p>
                        <p className="card-text">{item.price} ARS</p>
                        { item.discount > 0 && <p className="card-text offer">-{item.discount}%</p> }
                        <Link to={"/item/"+item.id+"#detail"}><button className="btn btn-outline-secondary"><BsEye /></button></Link>
